    ...
    config.vm.define vm_name = "%s-%02d" % [$instance_name_prefix, i] do |config|
      ...
      if (reapplyUserData)
        ...
        if File.exist?(CLOUD_CONFIG_PATH)
          ...
          config.vm.provision :shell, run: "always" ,:inline => "mv /tmp/vagrantfile-user-data /var/lib/coreos-vagrant/ && coreos-cloudinit --from-file  /var/lib/coreos-vagrant/vagrantfile-user-data", :privileged => true
        end 
